...
class ExtratorContaConsumoVodafone(ExtratorContaConsumoBase):
    def get_info(self, texto: str) -> ContaConsumo:
        ...
        conta_consumo.data_emissao = self.get_data(texto, 'Data de emissão:','Entidade:')
        conta_consumo.valor = self.get_data(texto, 'Valor desta fatura com IVA','Total a pagar até') #Entre valores que mudam
