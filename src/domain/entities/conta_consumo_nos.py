...
class ContaConsumoNOS(ContaConsumoBase):
    ...
    def create(self, text: str) -> None:
        ...
        self.str_vencimento = self._get_data(text, 'Debito direto a partir do dia:', 'IBAN da sua conta bancaria')
        ...
        self.str_vencimento = self._convert_2_default_date(self.str_vencimento, 'YMD', full_month=True)
